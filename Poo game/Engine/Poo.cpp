...
void Poo::ProcessConsumption(int Dude0x, int Dude0y, int Dude0width, int Dude0height)
{
	const int left0 = Dude0x;
	const int right0 = Dude0x + Dude0width;
	const int top0 = Dude0y;
	const int bottom0 = Dude0y + Dude0height;
	const int left1 = x;
